...
func (m *IdentityAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IdentityAttributes.Merge(m, src)
}
...
func (m *IdentityProviderReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IdentityProviderReq.Merge(m, src)
}
...
func (m *CreateIdentityReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateIdentityReq.Merge(m, src)
}
...
func (*CreateIdentityReq_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_61c7956abb761639, []int{4, 0}
}
...
func (m *CreateIdentityReq_Data) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateIdentityReq_Data.Merge(m, src)
}
...
func (m *NewIdentityAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewIdentityAttributes.Merge(m, src)
}
