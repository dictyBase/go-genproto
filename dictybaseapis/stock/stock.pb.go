...
func (m *StrainProperties) GetDescriptor_() string {
	if m != nil {
...
func (m *PlasmidProperties) GetKeywords() []string {
	if m != nil {
		return m.Keywords
	}
	return nil
...
type NewStock_Data struct {
	...
	// Unique ID for stock
	Id                   string              `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	Attributes           *NewStockAttributes `protobuf:"bytes,3,opt,name=attributes,proto3" json:"attributes,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *NewStock_Data) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
type NewStockAttributes struct {
	...
	// Depositor of the stock
	Depositor string `protobuf:"bytes,5,opt,name=depositor,proto3" json:"depositor,omitempty"`
	// List of associated genes
	Genes []string `protobuf:"bytes,6,rep,name=genes,proto3" json:"genes,omitempty"`
	// List of database cross references
	Dbxrefs []string `protobuf:"bytes,7,rep,name=dbxrefs,proto3" json:"dbxrefs,omitempty"`
	// List of related publications
...
func (m *StrainUpdateProperties) GetDescriptor_() string {
	if m != nil {
		return m.Descriptor_
	}
	return ""
...
type StrainListParameters struct {
	// A unique pointer to the next set of result in the list
	Cursor int64 `protobuf:"varint,1,opt,name=cursor,proto3" json:"cursor,omitempty"`
	// Maximum number of records that can be fetch per request
	Limit int64 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`
	...
	//        field_name operator expression
	//
	// The following fields of `StrainProperties` definition are allowed to
	// be used for filtering
	//   * depositor          - Depositor of the stock (string).
	...
	//                          YYYY-MM-DD, YYYY-MM, YYYY
	//
	// field_name - Any one of the allowed field_name of the `StrainProperties` definition.
	// operator - Defines the type of filter match to use. It could be any of
	// the following four and all of them should be URL-encoded for http request.
	//
	//        Operators for strings
...
func (m *StrainListParameters) Reset()         { *m = StrainListParameters{} }
func (m *StrainListParameters) String() string { return proto.CompactTextString(m) }
func (*StrainListParameters) ProtoMessage()    {}
func (*StrainListParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_c87a7814fbd674bd, []int{12}
}

func (m *StrainListParameters) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StrainListParameters.Unmarshal(m, b)
}
func (m *StrainListParameters) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StrainListParameters.Marshal(b, m, deterministic)
}
func (m *StrainListParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StrainListParameters.Merge(m, src)
}
func (m *StrainListParameters) XXX_Size() int {
	return xxx_messageInfo_StrainListParameters.Size(m)
}
func (m *StrainListParameters) XXX_DiscardUnknown() {
	xxx_messageInfo_StrainListParameters.DiscardUnknown(m)
}

var xxx_messageInfo_StrainListParameters proto.InternalMessageInfo

func (m *StrainListParameters) GetCursor() int64 {
	if m != nil {
		return m.Cursor
	}
	return 0
...
func (m *StrainListParameters) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *StrainListParameters) GetFilter() string {
	if m != nil {
		return m.Filter
	}
	return ""
...
type PlasmidListParameters struct {
	// A unique pointer to the next set of result in the list
	Cursor int64 `protobuf:"varint,1,opt,name=cursor,proto3" json:"cursor,omitempty"`
	// Maximum number of records that can be fetch per request
	Limit int64 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`
	...
	//        field_name operator expression
	//
	// The following fields of `PlasmidProperties` definition are allowed to
	// be used for filtering
	//   * depositor          - Depositor of the plasmid (string).
	//   * summary            - Summary of the plasmid (string)
	//   * keyword            - Keywords used for the plasmid (string), searches in the "keywords" attribute
	//   * created_at         - Date the stock was created (number), can be in the
	//                          following formats:
	//                          YYYY-MM-DD, YYYY-MM, YYYY
	//   * updated_at         - Date the stock was updated (number), can be in the
	...
	//                          YYYY-MM-DD, YYYY-MM, YYYY
	//
	// field_name - Any one of the allowed field_name of the `PlasmidProperties` definition.
	// operator - Defines the type of filter match to use. It could be any of
	// the following four and all of them should be URL-encoded for http request.
	//
	//        Operators for strings
...
func (m *PlasmidListParameters) Reset()         { *m = PlasmidListParameters{} }
func (m *PlasmidListParameters) String() string { return proto.CompactTextString(m) }
func (*PlasmidListParameters) ProtoMessage()    {}
func (*PlasmidListParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_c87a7814fbd674bd, []int{13}
}

func (m *PlasmidListParameters) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PlasmidListParameters.Unmarshal(m, b)
}
func (m *PlasmidListParameters) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PlasmidListParameters.Marshal(b, m, deterministic)
}
func (m *PlasmidListParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PlasmidListParameters.Merge(m, src)
}
func (m *PlasmidListParameters) XXX_Size() int {
	return xxx_messageInfo_PlasmidListParameters.Size(m)
}
func (m *PlasmidListParameters) XXX_DiscardUnknown() {
	xxx_messageInfo_PlasmidListParameters.DiscardUnknown(m)
}

var xxx_messageInfo_PlasmidListParameters proto.InternalMessageInfo

func (m *PlasmidListParameters) GetCursor() int64 {
	if m != nil {
		return m.Cursor
	}
	return 0
...
func (m *PlasmidListParameters) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *PlasmidListParameters) GetFilter() string {
	if m != nil {
		return m.Filter
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ListParameters)(nil), "dictybase.stock.ListParameters")
	proto.RegisterType((*StrainListParameters)(nil), "dictybase.stock.StrainListParameters")
	proto.RegisterType((*PlasmidListParameters)(nil), "dictybase.stock.PlasmidListParameters")
...
var fileDescriptor_c87a7814fbd674bd = []byte{
	...
	,
}
...
type StockServiceClient interface {
	...
	// List all stocks
	ListStocks(ctx context.Context, in *ListParameters, opts ...grpc.CallOption) (*StockCollection, error)
	// List all strains
	ListStrains(ctx context.Context, in *StrainListParameters, opts ...grpc.CallOption) (*StockCollection, error)
	// List all plasmids
	ListPlasmids(ctx context.Context, in *PlasmidListParameters, opts ...grpc.CallOption) (*StockCollection, error)
}
...
func (c *stockServiceClient) ListStocks(ctx context.Context, in *ListParameters, opts ...grpc.CallOption) (*StockCollection, error) {
...
func (c *stockServiceClient) ListStrains(ctx context.Context, in *StrainListParameters, opts ...grpc.CallOption) (*StockCollection, error) {
	out := new(StockCollection)
...
func (c *stockServiceClient) ListPlasmids(ctx context.Context, in *PlasmidListParameters, opts ...grpc.CallOption) (*StockCollection, error) {
	out := new(StockCollection)
...
type StockServiceServer interface {
	...
	// List all stocks
	ListStocks(context.Context, *ListParameters) (*StockCollection, error)
	// List all strains
	ListStrains(context.Context, *StrainListParameters) (*StockCollection, error)
	// List all plasmids
	ListPlasmids(context.Context, *PlasmidListParameters) (*StockCollection, error)
}
...
func _StockService_ListStocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServiceServer).ListStocks(ctx, req.(*ListParameters))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StockService_ListStrains_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServiceServer).ListStrains(ctx, req.(*StrainListParameters))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StockService_ListPlasmids_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServiceServer).ListPlasmids(ctx, req.(*PlasmidListParameters))
	}
	return interceptor(ctx, in, info, handler)
}
