...
type ExistingOrderAttributes struct {
	...
	// Account identification used for courier service
	CourierAccount string `protobuf:"bytes,3,opt,name=courier_account,json=courierAccount,proto3" json:"courier_account,omitempty"`
	// Any comments about the order
	...
	// Order number for purchase
	PurchaseOrderNum string `protobuf:"bytes,6,opt,name=purchase_order_num,json=purchaseOrderNum,proto3" json:"purchase_order_num,omitempty"`
	// Status of order
	Status OrderStatus `protobuf:"varint,7,opt,name=status,proto3,enum=dictybase.order.OrderStatus" json:"status,omitempty"`
	// Person (user) who is receiving the stocks in mail
	Consumer string `protobuf:"bytes,8,opt,name=consumer,proto3" json:"consumer,omitempty"`
	// Person (user) who is paying for the stocks
	Payer string `protobuf:"bytes,9,opt,name=payer,proto3" json:"payer,omitempty"`
	// Person who is ordering (logged in user)
	Purchaser string `protobuf:"bytes,10,opt,name=purchaser,proto3" json:"purchaser,omitempty"`
	// List of items in the order, in this case it will be mostly biological
	// stocks such as plasmids and strains
...
var fileDescriptor_cd01338c35d87077 = []byte{
	...
	,
}
