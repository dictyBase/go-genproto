...
package pubsub // import "github.com/dictyBase/go-genproto/dictybaseapis/pubsub"
...
func (*Reply) Descriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_305a00c009022cff, []int{0}
}
...
func (*IdentityReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_305a00c009022cff, []int{1}
}
...
func (dst *IdentityReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IdentityReply.Merge(dst, src)
}
...
func (*IdentityReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_305a00c009022cff, []int{2}
}
...
func (dst *IdentityReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IdentityReq.Merge(dst, src)
}
...
type UserReply struct {
	...
	Users *user.UserCollection `protobuf:"bytes,2,opt,name=users" json:"users,omitempty"`
	// Status error model, look here
	// for detail https://github.com/googleapis/googleapis/blob/master/google/rpc/status.proto
...
func (*UserReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_305a00c009022cff, []int{3}
}
...
func (*IdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_305a00c009022cff, []int{4}
}
...
func init() { proto.RegisterFile("pubsub.proto", fileDescriptor_pubsub_305a00c009022cff) }

var fileDescriptor_pubsub_305a00c009022cff = []byte{
