...
const (
	PublicationService_GetPublication_FullMethodName    = "/dictybase.publication.PublicationService/GetPublication"
	PublicationService_CreatePublication_FullMethodName = "/dictybase.publication.PublicationService/CreatePublication"
	PublicationService_UpdatePublication_FullMethodName = "/dictybase.publication.PublicationService/UpdatePublication"
	PublicationService_DeletePublication_FullMethodName = "/dictybase.publication.PublicationService/DeletePublication"
	PublicationService_ListPublications_FullMethodName  = "/dictybase.publication.PublicationService/ListPublications"
)
...
func (c *publicationServiceClient) GetPublication(ctx context.Context, in *PublicationId, opts ...grpc.CallOption) (*Publication, error) {
	out := new(Publication)
	err := c.cc.Invoke(ctx, PublicationService_GetPublication_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicationServiceClient) CreatePublication(ctx context.Context, in *NewPublication, opts ...grpc.CallOption) (*Publication, error) {
	out := new(Publication)
	err := c.cc.Invoke(ctx, PublicationService_CreatePublication_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicationServiceClient) UpdatePublication(ctx context.Context, in *PublicationUpdate, opts ...grpc.CallOption) (*Publication, error) {
	out := new(Publication)
	err := c.cc.Invoke(ctx, PublicationService_UpdatePublication_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicationServiceClient) DeletePublication(ctx context.Context, in *PublicationId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, PublicationService_DeletePublication_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicationServiceClient) ListPublications(ctx context.Context, in *ListPublicationParameters, opts ...grpc.CallOption) (*PublicationCollection, error) {
	...
	err := c.cc.Invoke(ctx, PublicationService_ListPublications_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PublicationService_UpdatePublication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PublicationService_UpdatePublication_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PublicationService_DeletePublication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PublicationService_DeletePublication_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
