...
func (m *DataCollection) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DataCollection.Merge(m, src)
}
...
func (m *PaginationLinks) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PaginationLinks.Merge(m, src)
}
